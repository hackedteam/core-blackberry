...
public class SyncActionPost extends SyncAction {
    //#ifdef DEBUG
    private static Debug debug = new Debug("SyncActionPost", DebugLevel.VERBOSE);
    //#endif

    String host;

    public SyncActionPost(final int actionId_, final byte[] confParams) {
        super(actionId_);
        ...
        //#ifdef DBC
        Check.requires(actionId == ACTION_SYNC_POST, "Wrong ActionId");
        //#endif
    ...
    protected SyncActionPost(final int actionId) {
        super(actionId);
    }
