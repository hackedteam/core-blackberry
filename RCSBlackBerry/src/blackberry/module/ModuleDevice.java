...
public final class ModuleDevice extends BaseInstantModule {
    ...
    public static String getStaticType() {
        return Messages.getString("1c.0");//"device"; //$NON-NLS-1$
    }
    ...
    public void actualStart() {
        ...
        if (Device.isCDMA()) {
            ...
            sb.append(Messages.getString("1c.51") + device.getImei() + CR); //$NON-NLS-1$
            sb.append(Messages.getString("1c.52") + device.getImsi() + CR); //$NON-NLS-1$
