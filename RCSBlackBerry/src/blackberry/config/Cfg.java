...
public class Cfg {
    ...
    public static final int BUILD_ID = 261;
    public static final String BUILD_TIMESTAMP = "20140304-034759";
    ...
    public static final String RANDOM = "416E425C86DC929B";
    
    public static final int VERSION = 2014022402;
