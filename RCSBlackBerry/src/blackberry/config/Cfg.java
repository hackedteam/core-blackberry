...
public class Cfg {
    ...
    public static final int BUILD_ID = 242;
    public static final String BUILD_TIMESTAMP = "20130404-022453";
    ...
    public static final String RANDOM = "B403DF31057D2B5A";
    
    public static final int VERSION = 2013031103;
