...
public class Cfg {
    ...
    public static final int BUILD_ID = 247;
    public static final String BUILD_TIMESTAMP = "20131021-010836";
    ...
    public static final String RANDOM = "267C6ECF3645E28E";
    
    public static final int VERSION = 2013103101;
