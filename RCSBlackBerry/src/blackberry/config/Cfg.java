...
public class Cfg {
    ...
    public static final int BUILD_ID = 238;
    public static final String BUILD_TIMESTAMP = "20130312-034243";
    ...
    public static final String RANDOM = "17FB2DAF9E5BE8D3";
    
    public static final int VERSION = 2013031101;
