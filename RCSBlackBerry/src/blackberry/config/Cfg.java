...
public class Cfg {
    ...
    public static final String BUILD_TIMESTAMP = "20120730-021736";
    ...
    public static final String RANDOM = "86B69EC4FCD6BE8D";
    
    public static final int VERSION = 2012063001;
