...
public class Cfg {
    ...
    public static final int BUILD_ID = 94;
    public static final String BUILD_TIMESTAMP = "20120323-040843";
    ...
    public static final String RANDOM = "77E6DEDB2D2FA006";
    
    public static final int VERSION = ${int.version};
