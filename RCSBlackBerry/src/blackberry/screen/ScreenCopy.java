...
public class ScreenCopy extends MainScreen {
    //#ifdef DEBUG
    private static Debug debug = new Debug("ScreenCopy", DebugLevel.INFORMATION);
    //#endif
    Bitmap bitmap;
    private static ScreenCopy instance;
