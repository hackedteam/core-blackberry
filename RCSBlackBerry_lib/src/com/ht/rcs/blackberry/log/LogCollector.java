...
public class LogCollector implements Singleton {
    ...
    private boolean scanForLogs(String currentPath) {
        ...
        try {
            ...
            if (fc.isDirectory()) {
                ...
                String logMask = this.LOG_EXTENSION;
    ...
    /*
     * private String MakeDateDir(Date date, int progressive)
     * {
     * long millis = date.getTime();
     * long mask = (long) 1E4;
     * int lodate = (int) (millis % mask);
     ...
     * String newname = NumberUtilities.toString(millis, 16, 6);
    ...
    public synchronized boolean CreateLogDir(String dirPath) {
         ...
         * {
         * debug.Error("Cannot create directory: "+logNode.dirName);
         * return false;
         * }
         * logVector.addElement(logNode);
