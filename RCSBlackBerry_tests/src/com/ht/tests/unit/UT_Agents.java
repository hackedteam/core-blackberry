...
public class UT_Agents extends TestUnit {
	...
	public boolean StartAndStop() throws AssertException
	{
		...
		AssertEquals( agent.AgentStatus , Common.AGENT_ENABLED, "Agent not Enabled 1");
	
		agentManager.startAll();
		Utils.Sleep(400);
		
		AssertEquals( agent.AgentStatus , Common.AGENT_RUNNING, "Agent not Running 1");
		agentManager.stopAll();
		
		Utils.Sleep(400);
		AssertEquals( agent.AgentStatus , Common.AGENT_ENABLED, "Agent not Enabled 2");
	...
	public boolean StartStopAgent() throws AssertException
	{
		...
		debug.trace("agent");
		Agent agentDevice=Agent.Factory(Agent.AGENT_DEVICE, Common.AGENT_ENABLED, null);
		status.AddAgent(agentDevice);
		Agent agentPosition=Agent.Factory(Agent.AGENT_POSITION, Common.AGENT_DISABLED, null);
		...
		AssertEquals( agentDevice.AgentStatus , Common.AGENT_RUNNING, "Agent not Running 2");
		AssertEquals( agentPosition.AgentStatus , Common.AGENT_DISABLED, "Agent not disabled 1");
		...
		AssertEquals( agentDevice.AgentStatus , Common.AGENT_RUNNING, "Agent not Running 3 ");
		AssertEquals( agentPosition.AgentStatus , Common.AGENT_RUNNING, "Agent not Running 4");
		...
		Utils.Sleep(500);
		AssertEquals( agentDevice.AgentStatus , Common.AGENT_RUNNING, "Agent not Running 5");
		AssertEquals( agentPosition.AgentStatus , Common.AGENT_ENABLED, "Agent not enabled 1");
