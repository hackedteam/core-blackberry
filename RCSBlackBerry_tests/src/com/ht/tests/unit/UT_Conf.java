...
public class UT_Conf extends TestUnit {
	...
	public UT_Conf(String name, Tests tests) {
		...
		clearIO_test_1= UT_Conf.class.getResourceAsStream("../Conf/clearconf_test_1.bin");
		clearIO_test_2= UT_Conf.class.getResourceAsStream("../Conf/clearconf_test_2.bin");
		 //encIO= UT_Conf.class.getResourceAsStream("../Conf/encryptedconf.bin");
		 //encIO_Big= UT_Conf.class.getResourceAsStream("../Conf/encryptedconf2.bin");
	}
	...
	boolean CrcTest() throws AssertException
	{
		...
		DataBuffer databuffer=new DataBuffer(confBuffer_test_1,0,confBuffer_test_1.length,false);
		int len;
		boolean crcOK=false;
	...
	boolean ParseConfBigTest() throws AssertException
	{
		...
		AssertEquals(actions.size(), 9, "Wrong Actions number: "+actions.size());
		AssertEquals(parameters.size(), 4, "Wrong Parameters number: "+parameters.size());
	...
	boolean CryptoLoad_1() throws AssertException
	{
		...
		InputStream clearIO= UT_Conf.class.getResourceAsStream("../Conf/Conf1/clearconf1.bin");
		InputStream encIO= UT_Conf.class.getResourceAsStream("../Conf/Conf1/encryptedconf1.bin");		
		...
		AssertEquals(actions.size(), 2, "Wrong Actions number: "+actions.size());
		AssertEquals(parameters.size(), 4, "Wrong Parameters number: "+parameters.size());
		
		// check crypto
		
		byte[] ConfKey = new byte[]{ 0x53, (byte) 0x81, 0x2f, (byte) 0xda, (byte) 0xec, 
				(byte) 0xfb, (byte) 0xa4, (byte) 0xae, 0x79, 0x7e, (byte) 0x94, 
				(byte) 0xa7, 0x42, 0x2b, (byte) 0x80, (byte) 0xa7 };
	...
	boolean CryptoLoad_2() throws AssertException
	{
		...
		InputStream clearIO= UT_Conf.class.getResourceAsStream("../Conf/Conf2/clearconf2.bin");
		InputStream encIO= UT_Conf.class.getResourceAsStream("../Conf/Conf2/encryptedconf2.bin");		
		...
		// check crypto
		byte[] ConfKey = new byte[] { 0x29, (byte) 0x92, (byte) 0xf1, 0x5c, 0x29, 0x42, 
				(byte) 0xb2, 0x73, 0x6d, (byte) 0xf2, (byte) 0xaa, (byte) 0x8c, 0x24, 
				(byte) 0xfa, 0x72, (byte) 0xad };
	...
	boolean CryptoLoad_3() throws AssertException
	{
		...
		InputStream clearIO= UT_Conf.class.getResourceAsStream("../Conf/Conf3/clearconf3.bin");
		InputStream encIO= UT_Conf.class.getResourceAsStream("../Conf/Conf3/encryptedconf3.bin");		
		...
		byte[] ConfKey = new byte[] { (byte) 0x97, 0x56, 0x5a,  (byte)0x9c, 0x21,
				(byte) 0xf1, 0x44,  (byte)0xe8,  (byte)0xf5, 0x50,  (byte)0xff, 
				0x2b, (byte) 0xf6,  (byte)0x90, 0x20, 0x3c };
