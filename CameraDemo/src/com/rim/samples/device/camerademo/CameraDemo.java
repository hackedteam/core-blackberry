...
final class CameraScreen extends MainScreen
{
     ...
     */
    private MenuItem _encodingMenuItem = new MenuItem(new StringProvider("Encoding Settings"), 0x230010, 0) 
    {
        public void run()
        {            
     ...
     */
    private MenuItem _toggleAutoFocusMenuItem = new MenuItem(new StringProvider("Toggle Auto-focus"), 0x230020, 0) 
    {
        public void run()
        {            
            try
            {            
                ...
                {
                    CameraDemo.errorDialog("ERROR: Focus control not initialized.");
                }
            }
            catch(Exception e)
            {
    ...
    private void initializeCamera()
    {
        try
        {
            ...
            _zoomControl = (ZoomControl)player.getControl( "javax.microedition.amms.control.camera.ZoomControl" );
        }
        catch(Exception e)
        {
            CameraDemo.errorDialog("ERROR " + e.getClass() + ":  " + e.getMessage());
